...
<!--             @if (Route::has('login'))
    ...
    <div class="row">
        ...
        <?php foreach ($zaiv as $req) {
            # code...
        }?>
        <div class="row mt-3">
            <div class="col-md-1">Город</div>
            <div class="col-md-1">Организация</div>
            <div class="col-md-2">Адресс</div>
            <div class="col-md-2">Время-начала</div>
            <div class="col-md-2">Текущий шаг</div>
            <div class="col-md-2">Статус</div>
            <div class="col-md-2">Кнопки</div>
    </div>
    <div class="row">
            <div class="col-md-1"><?=$req->organisation_id ?></div>
            <div class="col-md-1">Организация</div>
            <div class="col-md-2">Адресс</div>
            <div class="col-md-2">Время-начала</div>
            <div class="col-md-2">Текущий шаг</div>
